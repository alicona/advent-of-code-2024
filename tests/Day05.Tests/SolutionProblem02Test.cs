...
namespace Day05Test
{
    internal sealed class SolutionProblem02Test
    {
        private SolutionProblem02 _sut;

        [SetUp]
        public void SetUp() 
        {
            _sut = new SolutionProblem02();
        }

        [TestCase("rules_sample.txt", "input_sample.txt", 123)]
        ...
        public void Test(string rulesFileName, string inputFileName, int expected) 
        {
            ...
            var result = _sut.Calculate(rules, updates);
